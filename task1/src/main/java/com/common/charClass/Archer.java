 ...
 * 궁수 클래스
 */
public class Archer extends Freshman {
     ...
     */
    public Archer() {
        this(new Invincible(), new Weapon.WeaponType[]{Weapon.WeaponType.BOW}, 99, Species.ELF);
    }

    public Archer(SkillImpl specialSkill, Weapon.WeaponType[] availableWeaponList, int requiredLevel, Species requiredSpecies) {
